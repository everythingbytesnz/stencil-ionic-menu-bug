...
const index$1 = require('./index-0c519ee7.js');
const cubicBezier = require('./cubic-bezier-24e309bf.js');
const frameworkDelegate = require('./framework-delegate-1aa81336.js');
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-5ce7ca82.js'); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
