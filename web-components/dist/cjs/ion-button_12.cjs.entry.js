...
const UoaHeader = class {
  ...
  render() {
    ...
    const slotLogo = (index.h("a", { href: "/", class: classes }, index.h("uoa-logo", { color: this.color, logoType: this.logoType, size: this.size, "aria-label": "The University of Auckland logo" })));
    const slotStart = (index.h("div", { class: "flex-same-size" }, index.h("slot", { name: "start" }, "\u00A0 ")));
    const slotEnd = (index.h("div", { class: "flex-same-size" }, index.h("slot", { name: "end" }, "\u00A0"), index.h("slot", null)));
...
const UoaHelp = class {
  ...
  render() {
    return index.h("a", { class: "link", tabindex: "0", onClick: () => this._presentModal(), ref: el => (this.helpLink = el), color: "primary", innerHTML: this.linkText });
  }
  get el() { return index.getElement(this); }
};
...
const UoaLogo = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("ion-icon", { name: "university of Auckland Logo", src: index.getAssetPath(`../assets/logo/${logo_generic}`), class: classes })));
  }
  static get assetsDirs() { return ["../assets"]; }
};
...
const SearchAutocomplete = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.searchedText = index.createEvent(this, "searchedText", 7);
    /**
  ...
  showClearButton() {
    if (this._searchValue) {
      return (index.h("ion-button", { size: "small", fill: "clear", type: "reset", onClick: () => this.resetSearchField(), "aria-label": "Clear search field" }, index.h("ion-icon", { src: "assets/icons/close-filled.svg", "aria-hidden": "true" })));
    }
  }
  showAutoComplete() {
    if (this.filteredOptions.length > 0) {
      return (index.h("ion-list", { class: "autocomplete-items" }, index.h("ul", { role: "listbox", onKeyDown: e => this._handleKeydownListItem(e), ref: el => (this.ionList = el) }, this.filteredOptions.map((option, index$1) => {
        let id = 'items-' + index$1;
        return (index.h("li", { key: id, id: id, role: "option", onClick: _ => this.emitSearchValue(option) }, option));
      }))));
    }
  }
  AddAriaSuggestions() {
  ...
  showSearchButton() {
    if (this.searchButton) {
      return (index.h("ion-button", { color: "primary", expand: "full", fill: "solid", onClick: _ => this.emitSearchValue(this._searchValue) }, index.h("ion-icon", { name: "search", slot: "icon-only" })));
    }
  }
  render() {
    return (index.h(index.Host, null, index.h("ion-item", { lines: "none" }, index.h("div", { class: "input-field" }, index.h("div", { class: "suggestions-help", role: "status", "aria-live": "polite" }, this.AddAriaSuggestions()), index.h("ion-input", { placeholder: this.placeholder, "data-suggest": true, type: "text", autocomplete: "off", value: this._searchValue, onInput: e => this._handleInput(e), ref: el => (this.searchInput = el), onKeyDown: e => this._handleKeydown(e), "aria-autocomplete": "list" }), this.showClearButton()), this.showSearchButton()), this.showAutoComplete()));
  }
  _handleInput(event) {
...
const StepsBar = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.stepClicked = index.createEvent(this, "stepClicked", 7);
    /**
  ...
  createDefaultSteps() {
    ...
    for (let i = 0; i < this.steps; i++) {
      content.push(index.h("ion-button", { fill: "clear", class: {
          [`step-bar`]: true,
          [`done`]: this.currentStep >= i + 1,
        }, onClick: () => {
          this.clickEventHandler(i + 1);
        }, disabled: this.currentStep < i + 1, "aria-label": this.getAriaLabel(i) }, this.currentStep > i + 1 ? index.h("ion-icon", { "aria-label": "", name: "checkmark" }) : index.h("span", null, i + 1)));
    }
    return content;
  }
  getAriaLabel(stepNo) {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "flex-space-between" }, this.getStepsContent())));
  }
  static get watchers() { return {
...
exports.uoa_header = UoaHeader;
exports.uoa_help = UoaHelp;
exports.uoa_logo = UoaLogo;
exports.uoa_search_autocomplete = SearchAutocomplete;
exports.uoa_steps_bar = StepsBar;
